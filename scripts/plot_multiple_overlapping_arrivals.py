#!/usr/bin/env python3
"""Plot inflow/outflow/queue diagnostics for overlapping-arrivals scenario."""
...
def main() -> None:
    ...
    out_png = Path("local/plots/multiple_overlapping_arrivals_wout100_eps001_diagnostics.png")
